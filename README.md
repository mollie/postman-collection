...
## Structure
The structure of the collections follows the structure of Mollie’s public API documentation. There is a call to each endpoint, and each call contains at least one example. The example set aims for showcasing the variety of options an endpoint offers, rather than showing every possibility.
